...
actually euclidean distance between the two input sonar patches, projected into lower dimension using contrastive loss.%TODO clean up this explaination
\newpage
%height was 6cm
...
%TODO talk about general VGG structure from the paper and say the actual values are to be determined in results section. The values are expected to be different because the dataset size, type everything is different.
